...
if ($_POST['stage'] == 'process') 
{
	...
	update_option('simpleldap_base_dn_group', $_POST['base_dn_group']);
...
$simpleldap_base_dn_group = get_option("simpleldap_base_dn_group");
...
<input name="base_dn" type="text" value="<?php  echo $simpleldap_base_dn; ?>" size="60" /><br />
*Example: For subdomain.domain.sufix use DC=subdomain,DC=domain,DC=suffix 
  </p>
<p><strong>Base DN for the Group:</strong><br />
<input name="base_dn_group" type="text" value="<?php  echo $simpleldap_base_dn_group; ?>" size="60" /><br />
</p>
...
<input name="mode" type="radio" value="mode_create_group" <?php if($simpleldap_login_mode=="mode_create_group"){echo "checked";}?>> <label for="mode_create_group">Create Wordpress account for users in specified LDAP group:</label> <input name="group_name" type="text" value="<?php  echo $simpleldap_group; ?>" size="60"/></p>
